    ...
    <div v-if="isLogin && cartList.length > 0">
        ...
        <div class="cart-item" v-for="item in cartList" :key="item.goods_id">
          ...
          <div class="info">
            ...
            <span class="bottom">
              ...
              <div class="count-box">
                <CountBox :value="item.goods.goods_num" @input="value => changeCount(value, item.goods_id, item.goods_sku_id)"></CountBox>
              </div>
            </span>
          </div>
        </div>
      ...
      <div class="footer-fixed">
        ...
        <div class="all-total">
          ...
          <div v-if="!isEdit" class="goPay" :class="{ disabled: selCount === 0 }" @click="goPay">结算</div>
